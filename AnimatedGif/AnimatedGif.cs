...
namespace AnimatedGif {
    public static class AnimatedGif {
        ...
        /// <returns></returns>
        public static AnimatedGifCreator Create(string filePath, int delay, int repeat = 0) => new AnimatedGifCreator(filePath, delay, repeat);
        ...
        public static GifBitmapDecoder Load(string filePath) => new GifBitmapDecoder(new Uri(filePath), BitmapCreateOptions.DelayCreation,
